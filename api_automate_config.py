...
endpoint_project = f"{jira_url}/rest/api/3/project"
...
if response2.status_code == 200:
    ...
    design_projects = [project for project in projects if "DESIGN" in project['key']]
    if design_projects:
...
statuses_endpoint = f"{jira_url}/rest/api/3/status"
...
df.to_csv("jira_data.csv", index=False)  # Saving to CSV
